...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C01842 implements AsyncCallbackPair<JSONObject> {
    ...
    class C01854 implements AsyncCallbackPair<String> {
    ...
    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C01842());
    }
    ...
    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C01854();
